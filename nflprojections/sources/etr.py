...
"""
ETR (Establish The Run) fantasy football projections using refactored functional components
"""
...
class ETRProjections:
    """ETR projections using separate functional components"""
